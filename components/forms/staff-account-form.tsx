...
export function StaffAccountForm({
  ...
  const form = useForm<StaffAccountFormValues>({
    ...
    defaultValues: { name: "", email: "", password: "", role: "1" },
  });
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
      <FieldGroup>
        ...
        <Field data-invalid={!!form.formState.errors.password}>
          ...
          />
          <FieldDescription>
            At least 8 characters. Share it securely with the new account
            holder.
          </FieldDescription>
        ...
        <Field data-invalid={!!form.formState.errors.role}>
          <FieldLabel htmlFor="account-role">Account role</FieldLabel>
          <Controller
            name="role"
